...
#ifndef SPECIFICRADIATIONFIELDPROBE_HPP
#define SPECIFICRADIATIONFIELDPROBE_HPP

#include "SpatialGridFormProbe.hpp"

////////////////////////////////////////////////////////////////////

/** SpecificRadiationFieldProbe probes the mean radiation field intensity as calculated by the simulation
...
class SpecificRadiationFieldProbe : public SpatialGridFormProbe
{
    ...
    ITEM_CONCRETE(SpecificRadiationFieldProbe, SpatialGridFormProbe,
                  "internal spatial grid: the mean radiation field intensity")
        ATTRIBUTE_TYPE_DISPLAYED_IF(SpecificRadiationFieldProbe, "Level2&SpatialGrid&SpecificRadiationField")
