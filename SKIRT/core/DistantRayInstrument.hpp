...
#ifndef RAYDISTANTINSTRUMENT_HPP
#define RAYDISTANTINSTRUMENT_HPP

#include "RayInstrument.hpp"

////////////////////////////////////////////////////////////////////

/** DistantRayInstrument is an abstract class for representing instruments positioned at a
    ...
    time. */
class DistantRayInstrument : public RayInstrument
{
    ITEM_ABSTRACT(DistantRayInstrument, RayInstrument, "a distant instrument")
...
public:
    ...
    void determineSameObserverAsPreceding(const RayInstrument* precedingInstrument);
